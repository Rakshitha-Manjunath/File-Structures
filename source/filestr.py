import time
f1=open(r"C:\Users\Rakshitha Manjunath\Downloads\fsprojt1.txt", errors='ignore')
cr=0
cont=f1.read()
co=cont.split("\n")
for i in co:
...
c=0
start=time.time()
with open(r"C:\Users\Rakshitha Manjunath\Downloads\fsprojt1.txt") as pack:
    with open(r"C:\Users\Rakshitha Manjunath\Downloads\index2.txt","w") as index:
        count=0
        f=pack.read()
        s=f.replace("\n","")
        for line in s.split(" "):
...
with open(r"C:\Users\Rakshitha Manjunath\Downloads\fsprojt1.txt") as main:
    with open(r"C:\Users\Rakshitha Manjunath\Downloads\index2.txt","r") as index:
...
if c==1:
    ...
    if ques=='Y' or ques=='y':
        ...
        f1=open(r"C:\Users\Rakshitha Manjunath\Downloads\fsprojt1.txt.txt","wt")
